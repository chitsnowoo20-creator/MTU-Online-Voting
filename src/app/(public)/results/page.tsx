  ...
  if (!latest) {
    return (
      <main className="flex flex-1 items-center justify-center bg-surface-1 px-4 py-16">
        <div className="w-full max-w-[560px] border border-hairline bg-canvas px-6 py-12 text-center">
    ...
    <main className="flex-1 bg-surface-1 px-4 py-16">
      <div className="mx-auto w-full max-w-[960px]">
        <div className="mb-8">
          ...
          <h1 className="text-display-md">{latest.name}</h1>
        </div>
          ...
          <section className="mt-12 border-t border-hairline pt-6">
            ...
            <ul className="mt-3 flex flex-col gap-2 text-body-sm">
              {earlier.map((election) => (
                <li key={election.id} className="flex justify-between gap-4">
